...
export const translations: TranslationMap = {
  en: {
    ...
    onboarding: "Welcome to LangTalk",
  ...
  ar: {
    ...
    onboarding: "مرحبًا بك في LangTalk",
  ...
  es: {
    ...
    onboarding: "Bienvenido a LangTalk",
  ...
  de: {
    ...
    onboarding: "Willkommen bei LangTalk",
  ...
  fr: {
    ...
    onboarding: "Bienvenue sur LangTalk",
  ...
  ko: {
    ...
    freeCalls: "무료 세션",
    onboarding: "LangTalk에 오신 것을 환영합니다",
    nativeLanguage: "모국어",
    country: "거주 국가",
  ...
  ru: {
    ...
    onboarding: "Добро пожаловать в LangTalk",
  ...
  tr: {
    ...
    onboarding: "LangTalk'a Hoş Geldiniz",
